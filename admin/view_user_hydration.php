        ...
        <div class="chart-section">
            <div class="hydration-chart-improved">
                <div class="chart-header" style="position: relative;">
                    ...
                    <button class="diary-calendar-icon-btn" onclick="showHydrationCalendar()" id="hydration-period-btn" title="Selecionar período" style="position: absolute; top: 50%; right: 0; transform: translateY(-50%); width: auto; height: auto; padding: 10px 20px; border-radius: 20px; font-size: 0.9rem; font-weight: 600; font-family: 'Montserrat', sans-serif;">
                        <i class="fas fa-calendar-alt" style="margin-right: 8px;"></i> <span id="hydration-period-text">Últimos 7 dias</span>
                    </button>
            </div>
