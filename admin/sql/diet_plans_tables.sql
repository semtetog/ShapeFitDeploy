-- Tabela para administradores/nutricionistas
CREATE TABLE IF NOT EXISTS sf_admins (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    email VARCHAR(255) UNIQUE NOT NULL,
    password_hash VARCHAR(255) NOT NULL,
    role ENUM('admin', 'nutritionist') DEFAULT 'nutritionist',
...
CREATE TABLE IF NOT EXISTS sf_user_groups (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nutri_id INT NOT NULL, -- ID do nutricionista que criou o grupo
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (nutri_id) REFERENCES sf_users(id) ON DELETE CASCADE
);
...
-- Inserir um administrador padrão (opcional)
INSERT INTO sf_admins (name, email, password_hash, role) VALUES
('Administrador', 'admin@shapefit.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin');
