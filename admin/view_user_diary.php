...
<style>
/* ========== DIÁRIO ALIMENTAR - ESTILOS COMPLETOS ========== */
...
.diary-nav-side {
    background: linear-gradient(145deg, #ff6b35, #ff8533);
    border: none;
    border-radius: 50px;
    padding: 12px 20px;
    color: white;
...
.diary-nav-side:hover {
    transform: translateY(-2px);
    box-shadow: 0 6px 20px rgba(255, 107, 53, 0.4);
}

.diary-nav-side:disabled {
    opacity: 0.5;
    cursor: not-allowed;
    transform: none;
}
...
.diary-food-list li:hover {
    background: rgba(255, 255, 255, 0.03);
    padding-left: 0.5rem;
    border-radius: 8px;
}

.diary-food-list li:last-child {
    border-bottom: none;
}
...
/* ========== MODAL DE CALENDÁRIO - REDESIGN COMPLETO ========== */
