        ...
        items.forEach(item => {
            ...
            if (textContent) {
                ...
                textContent.addEventListener('mousedown', function(e) {
                    // Se o clique foi no botão X, prevenir o foco
