<?php
// APPLY_ABACAXI_UNITS.php - Aplicar unidades corretas para o Abacaxi

require_once 'includes/config.php';
require_once APP_ROOT_PATH . '/includes/db.php';
require_once APP_ROOT_PATH . '/includes/units_manager.php';

echo "=== APLICANDO UNIDADES CORRETAS PARA O ABACAXI ===\n\n";
...
if ($food = $result->fetch_assoc()) {
    ...
    // Classificação real: fatias_pedacos + corte_porcao
    $categories = ['fatias_pedacos', 'corte_porcao'];
    echo "📋 Categorias: " . implode(' + ', $categories) . "\n";
    ...
    foreach (array_keys($unique_units) as $unit_abbr) {
        ...
        if ($unit_data) {
            ...
            $is_default = ($unit_abbr === 'g' || $unit_abbr === 'un');
